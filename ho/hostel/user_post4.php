    ...
    <form method="POST" id="postForm">
        ...
        <table id="postTable">
            ...
            $categories = [
                "मंजूर_पदे",                          // row 2
                "कार्यारत_पदे",                       // row 3
                "संभाव्य_भरवयाची_पदे",                // row 4 → मंजूर - कार्यारत
                "दिनांक",                             // row 5 → "दिनांक" with date picker in Category column
            ...
            foreach ($categories as $index => $cat) {
                ...
                if ($cat === "दिनांक") {
                    // Show "दिनांक" text with date picker in first column
                    echo '<td>';
                    echo '<div class="category-date-wrapper">';
                    echo '<span class="category-date-label">दिनांक</span>';
                ...
                for ($i = 0; $i < 11; $i++) {
                    if ($cat === "दिनांक") {
                        // For date row, show regular number inputs (not date pickers)
                        echo "<td><input type='number' name='data[$cat][col$i]' value='0' oninput='calculateTotals()'></td>";
                    } else {

...
<body>
    ...
    <form method="POST" id="postForm">
        ...
        <table id="postTable">
            ...
            $categories = [
                "मंजूर_पदे",                          // row 2
                "कार्यारत_पदे",                       // row 3
                "दिनांक_भरावयाची_पदे",                // row 4 → मंजूर - कार्यारत (WITH DATE PICKER)
                "कालावधितील_संभाव्य_भरावयाची_पदे",   // row 5 → WITH FROM-TO DATE PICKERS
                "एकूण_भरावयाची_पदे",                   // row 6 → दिनांक + कालावधितील
                "अतिरिक्त_पदे"                       // row 7
            ];
    ...
    <table id="sebcTable" border="1" cellpadding="8" cellspacing="0" style="border-collapse: collapse; width:100%;">
        <tr>
            <th>पाहिल्या भरती वर्षात भरावयाची पदे</th>
            <th>एसईबीसी भरती करीता पाहिल्या भरती वर्षात एकुन भरावच्या पदांच्या १०% नुसार येणारी पदे</th>
    ...
    <table id="financialTable" border="1" cellpadding="8" cellspacing="0" style="border-collapse: collapse; width:100%; text-align:center;" class="financial-table">
        <tr>

								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											...
											<a href="my-complaints.php" class="block-anchor panel-footer text-center">View My Posts &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
													<div class="stat-panel-number h1">New Post / नवीन गोषवारा बनविणे </div>
												</div>
											</div>
											<a href="user_post.php" class="block-anchor panel-footer text-center">Create New Post &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
